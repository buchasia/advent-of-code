...
class Operation01(Operation):
    ...
    def getValue(sequence, currentIndex, modes):
        ...
        # processed
        firstElement = Operation01.getSequenceElement(sequence, seqLength, currentIndex + 1, modes[0])
        secondElement = Operation01.getSequenceElement(sequence, seqLength, currentIndex + 2, modes[1])
