...
class Operation07(Operation):
    ...
    def getValue(sequence, currentIndex, modes):
        ...
        firstElement = Operation07.getSequenceElement(sequence, seqLength, currentIndex + 1, modes[0])
        secondElement = Operation07.getSequenceElement(sequence, seqLength, currentIndex + 2, modes[1])
