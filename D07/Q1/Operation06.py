...
class Operation06(Operation):
    ...
    def getValue(sequence, currentIndex, modes):
        ...
        firstElement = Operation06.getSequenceElement(sequence, seqLength, currentIndex + 1, modes[0])
        if firstElement == 0:
            secondElement = Operation06.getSequenceElement(sequence, seqLength, currentIndex + 2, modes[1])
